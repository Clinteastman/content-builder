...
const darkTheme = EditorView.theme({ '&': { backgroundColor: 'rgb(15 23 42)' } }) // slate-900
...
export const TemplateEditor: React.FC = () => {
  ...
  const extensions = useMemo(() => [
    syntaxHighlighting(createHighlightStyle(theme === 'dark')),
    ...
    EditorView.theme({
      ...
      '.cm-special': {
        color: theme === 'dark' ? '#60a5fa' : '#2563eb', // blue-400 : blue-600
        backgroundColor: theme === 'dark' ? 'rgb(15 23 42)' : 'rgb(239 246 255)', // slate-900 : blue-50
        padding: '0 2px',
        borderRadius: '2px'
      }
    })
